    ...
    <nav class="nav-bar"> 
         <div class="nav-bar__main">
             ...
             <div class="nav-bar__main--middle">
                <a href="/">
                    <div class="nav-bar__main--middle--logo"><img class="nav-bar__main--middle--logo--img" id="logo" src="./src/assets/images/logo new 2023 transperant cutted.png" alt="no-img"></div>
                </a>
             </div>
             <div class="nav-bar__main--right">
                 ...
                 <div class="nav-bar__main--right--contact" id="contact"><a href="/upload">UPLOAD</a></div>` : html`
